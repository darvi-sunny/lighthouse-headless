...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.lighthouse.localhost/ --auth https://id.lighthouse.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
...
Start-Process https://www.lighthouse.localhost/
