...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.lighthouse.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.lighthouse.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.lighthouse.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.lighthouse.localhost"
